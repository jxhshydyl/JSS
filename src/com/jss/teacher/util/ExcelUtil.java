...
public class ExcelUtil {
	...
	public static ArrayList<ArrayList<Object>> readExcel(InputStream file,String str){
		if(file == null){
			return null;
		}
		if("xlsx".equals(str)){
	 ...
	 * 网站上导出excel
	 */
	public static ByteArrayInputStream writeExcelWeb(ArrayList<ArrayList<Object>> result){
		if(result == null){
			return null;
		}
		HSSFWorkbook wb = new HSSFWorkbook();
