				...
				<div class="fbneirong">
					<form class="am-form" action="Question-addQuestion.action" method="post">
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<select name="qp.Cname" id="Cname"
									data-am-selected="{btnWidth: 190, btnSize: 'sm', btnStyle: 'default' }" disabled>
									<option value="c-01">java应用开发</option>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<textarea id="shiti" name="qp.Qcontent" style="width:680px;height:200px" readonly="readonly"></textarea>
							</div>
						</div>
							...
							<div class="you">
								<table class="am-table am-table-bordered" style="width:680px;" id="zengjiaxuanxiang">
									     ...
									     <tr align="center" valign="middle" name="xuanxianghangshu">
									         ...
									         <td><textarea  name="qp.Qcontent" style="width:550px;height:60px" id="1" readonly="readonly"></textarea></td>
									         <td><input type="radio" name="daan" value="A" disabled></td>
									     </tr>
									    <tr align="center" valign="middle" name="xuanxianghangshu">
									         <td id="fontinputbefore">B</td>
									         <td><textarea  name="qp.Qcontent" style="width:550px;height:60px" id="2" readonly="readonly"></textarea></td>
									         <td ><input type="radio" name="daan" value="B" disabled></td>
									     </tr>
									     <tr align="center" valign="middle" name="xuanxianghangshu">
									         <td id="fontinputbefore">C</td>
									         <td><textarea  name="qp.Qcontent" style="width:550px;height:60px" id="3" readonly="readonly"></textarea></td>
									         <td><input type="radio" name="daan" value="C" disabled></td>
									     </tr>
									     <tr align="center" valign="middle" name="xuanxianghangshu">
									         <td id="fontinputbefore">D</td>
									         <td><textarea  name="qp.Qcontent" style="width:550px;height:60px" id="4" readonly="readonly"></textarea></td>
									         <td><input type="radio" name="daan" value="D" disabled></td>
									     </tr>
                                     </table>
								</div>
						</div>
...
/*		 alert(table.rows.length);*/
		 ...
		 newtd1.innerHTML = '<textarea  name="qp.Qchoice" style="width:550px;height:60px" id="5" readonly="readonly">';
		 var newtd2 = newrow.insertCell(2);
		 if(leixing.value=="1"){
			 newtd2.innerHTML = '<input type="radio" name="daan" value="E" disabled>';
		 }else if(leixing.value=="2"){
			 newtd2.innerHTML = '<input type="checkbox" name="daan" value="E" disabled>';
		 }
