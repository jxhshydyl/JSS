		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			<ul class="am-nav am-nav-pills am-topbar-nav admin-header-list">
				<li class="am-dropdown tognzhi" data-am-dropdown>
					<button onclick="javascript:rightFrame.location.href='Message-queryAllMessage.action?isFirst=0'"
	...
	<div class="am-cf admin-main">
		<div class="nav-navicon admin-main admin-sidebar" >
			...
			<div class="sideMenu">
				...
				<ul>
					<li><a href="Class-queryAllClass.action?isFirst=0" target="rightFrame" >班级列表</a></li>
				</ul>
				...
				<ul id="work-list">
					...
					<li><a href="ArrangedTask-queryArrangedTask.action?isFirst=0" target="rightFrame">在线批阅</a></li>
				</ul>
				<h3 class="am-icon-cart-plus">
					<em></em> <a href="#">资料管理</a>
				</h3>
				<ul>
					<li><a href="Question-queryAllQuestion.action?isFirst=0" target="rightFrame">试题列表</a></li>
			...
			<div style="color:#2a3542;height: 200px">
			</div>
			<!-- sideMenu End -->
		</div>
		<iframe src="homepage.html" frameborder=0 width="1360px" height="600px" scrolling="no" name="rightFrame"></iframe>
	</div>
